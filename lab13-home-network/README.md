...
A small business owner reports that some users cannot open a website.
All PCs use **static IP addresses**. Use **ping** to find the issue.
...
**Question:**
Which PCs cannot connect to the web server?
- ```PC2```
...
**Question:**
Did you get a reply? What IP address is shown?
...
* Open **Web Browser** and connect to `www.cisco.pka` to confirm the issue is fixed.

...
All PCs use **static IP addresses** in the **192.168.1.0 /24** network. The PC
must access the web server **[www.cisco.pka](http://www.cisco.pka)**. Use
**ipconfig /all** to find the incorrectly configured PC.

...
**Question:** What command did you use to check the DHCP IP address?
...
**Question:** Did the command work? What was the result?
...
- Telnet may be disabled. Use SSH instead: `ssh -l admin 64.100.1.1` Enter
  password: `class`
...
**Question:** What appears after you successfully log in via SSH? `HQ#`

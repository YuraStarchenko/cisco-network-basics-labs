...
Clients (PCs) send service requests to servers. In this lab, a **PC connects
directly to a server** that provides **DNS** and **HTTP** services. You will
observe traffic when a web page is requested, how the URL is resolved to an IP,
and how the web page is delivered.
...
- In the Event List, click the **colored box** of the first event to open **PDU
  Information**
